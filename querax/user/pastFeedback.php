...
-->
  ...
  <div style="margin:10px">
          ...
          <h2 class="text-center">Your Liked Query</h2>
             </div>


               <?php
                 $result=mysqli_query($con,"SELECT * FROM `query` WHERE `myquery_id` =SOME(SELECT myquery_id FROM `feedback` WHERE `email` = '$email' AND type=1);");
